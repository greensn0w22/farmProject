...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
	...
	private Button syncUsers;
	private Button syncFields;
...
//        Cursor cursor = dbManager.fetch();
		...
		syncFields = (Button) findViewById(R.id.bt_get_fields);
        syncFields.setOnClickListener(this);

        syncUsers = (Button) findViewById(R.id.bt_get_users);
        syncUsers.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
            ...
            case R.id.bt_get_users:
                Toast.makeText(this, "COBOL", Toast.LENGTH_SHORT).show();
                break;
            case R.id.bt_get_fields:
                Toast.makeText(this, "mamonanaanannanana", Toast.LENGTH_LONG).show();
                break;
			default:
				break;
		}
...
//       TODO REFACTORING TO FLEX WITH TERNARY EXPRESSION :P
	...
	private String[] fetchUsersForDropDown() {
		...
		///   retunr new String[] dbManager.fetchUsers();
	}
}